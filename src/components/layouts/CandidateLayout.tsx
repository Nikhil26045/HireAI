    ...
    <div className="flex min-h-screen bg-neutral-50">
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="border-t border-neutral-200 p-4">
            <div className="flex items-center gap-3">
              <Avatar name="Candidate User" size="sm" />
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-medium text-neutral-900">Candidate User</p>
                <p className="truncate text-xs text-neutral-500">candidate@hireai.com</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b border-neutral-200 bg-white px-4 lg:px-6">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-neutral-500">Candidate Portal</span>
          </div>
        </header>
